...
export default function PlatformCompanyDetailPage() {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Sifre kurulum baglantisi uretilemedi.");
    } finally {
      setResetting(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-line bg-white p-4 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <div className="text-sm font-semibold text-slate-900">Kurulum Baglantisi Yenile</div>
            <div className="mt-0.5 text-xs text-muted">
              Sirket sahibi icin yeni bir sifre kurulum baglantisi uretir.
            </div>
          </div>
          <button
          ...
          >
            {resetting ? "Uretiliyor..." : "Yeni Kurulum Baglantisi Uret"}
          </button>
        </div>
        ...
        {resetLink ? (
          <div className="mt-4 space-y-2">
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2">
              <div className="text-xs font-medium text-emerald-700 mb-1">Baglanti Hazir</div>
              <div className="text-xs text-emerald-900">
                Bu baglantiyi owner kullanicisi ile paylasabilirsiniz.
              </div>
            ...
            >
              {resetCopied ? "Kopyalandi!" : "Kurulum URL Kopyala"}
            </button>
          </div>
        ) : null}
      </div>
