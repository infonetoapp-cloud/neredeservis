    ...
    <>
      <div className="rounded-2xl border border-line bg-surface p-4 shadow-sm">
        ...
        <div className="space-y-2">
          ...
          >
            Bu Rotanin Canli Seferlerini Ac
          </button>
          <button
            type="button"
            onClick={() => {
      ...
      <div className="rounded-2xl border border-line bg-surface p-4 shadow-sm">
        ...
        {activeTripsLoadStatus === "loading" ? (
          ...
          <p className="text-xs text-slate-500">Aktif sefer listesi icin rota sec.</p>
        ) : activeTrips.length === 0 ? (
          <p className="text-xs text-slate-500">Bu rota icin aktif sefer bulunamadi.</p>
        ) : (
          <div className="space-y-2">
