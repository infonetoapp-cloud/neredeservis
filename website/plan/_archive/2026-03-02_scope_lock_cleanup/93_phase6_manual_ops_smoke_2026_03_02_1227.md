...
Tarih: 2026-03-02 12:27:33
Durum: PARTIAL

| Scope | Check | Status | Detail |
| --- | --- | --- | --- |
| PROD | login page reachable | PASS | HTTP=200; note=- |
| PROD | giris page reachable | FAIL | HTTP=308; location=-; note=- |
| PROD | env badge match | FAIL | expected=PROD; actual=UNKNOWN; hostFallback=UNKNOWN |
