...
| STG | env badge match | FAIL | expected=STG; actual=PROD |
...
| STG | public route preview endpoint reachable | PASS | HTTP=404; note=HTTP redirect/error response |
