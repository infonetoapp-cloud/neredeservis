...
/// (Runbook 324BD).
class CoreHeartbeatIndicator extends StatefulWidget {
  const CoreHeartbeatIndicator({
    super.key,
    required this.state,
  ...
  @override
  State<CoreHeartbeatIndicator> createState() =>
      _CoreHeartbeatIndicatorState();
}

class _CoreHeartbeatIndicatorState extends State<CoreHeartbeatIndicator>
  ...
  void initState() {
    ...
    _burnInController = AnimationController(
      vsync: this,
      duration: CoreHeartbeatIndicator.burnInShiftDuration,
    )..repeat(reverse: true);
    _microShift = Tween<Offset>(
      begin: Offset.zero,
      end: CoreHeartbeatIndicator.burnInShiftOffset,
    ).animate(
  ...
  @override
  void didUpdateWidget(covariant CoreHeartbeatIndicator oldWidget) {
    ...
    switch (state) {
      case HeartbeatState.green:
        return const _HeartbeatPalette(
          core: CoreColors.success,
          ring: CoreColors.success,
        );
      case HeartbeatState.yellow:
        return const _HeartbeatPalette(
          core: CoreColors.amber500,
          ring: CoreColors.amber400,
        );
      case HeartbeatState.red:
        return const _HeartbeatPalette(
          core: CoreColors.danger,
          ring: CoreColors.danger,
        );
    }
  }
}
