...
class CoreSlideToFinish extends StatefulWidget {
  const CoreSlideToFinish({
    super.key,
    required this.onConfirmed,
    this.label = 'Seferi bitirmek icin kaydir',
    this.completedLabel = 'Sefer sonlandiriliyor...',
    this.isEnabled = true,
    this.tone = CoreSlideActionTone.danger,
  });
  ...
  /// Label shown after the action is confirmed.
  final String completedLabel;

  /// When false, the slider is visually dimmed and drag is ignored.
  final bool isEnabled;

  /// Visual tone of slider action.
  final CoreSlideActionTone tone;

  @override
  State<CoreSlideToFinish> createState() => _CoreSlideToFinishState();
}

class _CoreSlideToFinishState extends State<CoreSlideToFinish>
  ...
  Color get _accentColor {
    switch (widget.tone) {
      case CoreSlideActionTone.primary:
        return CoreColors.primary;
      case CoreSlideActionTone.danger:
        return CoreColors.dangerStrong;
    }
  }
          ...
          builder: (context, constraints) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                color:
                    _hasTriggered ? _accentColor : _accentColor.withAlpha(30),
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: <BoxShadow>[
                              BoxShadow(
                                color: _accentColor.withAlpha(90),
                                blurRadius: 8,
                                spreadRadius: 1,
                              ),
                            ],
  ...
  Widget build(BuildContext context) {
    ...
    return Opacity(
      ...
      child: Row(
        ...
        children: <Widget>[
          const SizedBox(width: CoreSpacing.space32),
          Text(
            label,
            style: const TextStyle(
              fontFamily: CoreTypography.bodyFamily,
          ...
          Icon(
            CoreIconTokens.caretDoubleRight,
            size: 18,
